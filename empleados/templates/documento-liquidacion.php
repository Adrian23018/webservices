    ...
    <table width="100%" cellpadding="10" cellspacing="0" style="color: #000000; background-color: #f5f5f5;">
      ...
      <tr >
        <td align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:13px;">
          <h2>Comprobante de liquidación del empleado</h2>
          <br/>
          <p>
            <?php echo $mensajeDespidoJustificado; ?>
            Has recibido el comprobante de liquidación generado por Uku para el empleado <?php echo utf8_encode($row_sqlEmpleados['emp_do_nombre']); ?> 
          </p>
        </td>
      </tr>
    </table>
