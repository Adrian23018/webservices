    ...
    <table width="100%" cellpadding="10" cellspacing="0" style="color: #000000; background-color: #f5f5f5;">
      ...
      <tr >
        <td align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:13px;">
          <h2>Comprobante de adelanto o préstamo del empleado</h2>
          <br/>
          <p>
            Has recibido el comprobante de adelanto o préstamo generado por Uku para el empleado <?php echo utf8_encode($row_sqlEmpleado['emp_do_nombre']); ?> 
          </p>
        </td>
      </tr>
    </table>
