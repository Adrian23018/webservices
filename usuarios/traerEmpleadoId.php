<?php
	...
	if ($validacion) {
		...
		while( $row_sqlEmpleados = mysqli_fetch_assoc($rs_sqlEmpleados) ){
			...
			$empleado["emp_do_fechanacimiento"] = utf8_encode($row_sqlEmpleados["emp_do_fechanacimiento"]);
			...
			$empleado["emp_cond_fecha_relacion"] = $dia.'/'.$mes.'/'.$anho;
