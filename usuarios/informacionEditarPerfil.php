<?php
	...
	if ($validacion) {
		...
		$result["sexo"] = utf8_encode($row_sqlMiPerfil['usu_sexo']);
		$result["nacionalidad"] = utf8_encode($row_sqlMiPerfil['usu_pais']);
		$result["no_identidad"] = utf8_encode($row_sqlMiPerfil['usu_no_identidad']);
		$result["domicilio"] = utf8_encode($row_sqlMiPerfil['usu_domicilio']);
